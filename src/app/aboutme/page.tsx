...
export default function Aboutme() {
    ...
    return (
        ...
        <div className={"aboutmepage"}>
            ...
            <p className="aboutme two">Currently I am skilled in writing both Front-end and Back-end codes simultaneously. For Front-end purpose I use <span>React.js</span> or <span>Next.js</span> and for Back-end I use <span>Nest.js</span> and <span>Django REST</span>. For database I am efficient in <span>MySQL</span> and also <span>MongoDB</span>. I am also proficient in hosting full-stack websites on <span>Amazon Web Services (AWS)</span> utilizing it&apos;s services - EC2, S3, DynamoDB, AWS Amplify, Cloudfront, Certificate Manager, Route 53 etc.</p>
